...
class newProducerThread implements Runnable {
    String name;
    Thread t;
    int n;
    boolean numberGenerated = false;

    newProducerThread(String threadName) {
...
class newConsumerThread implements Runnable {
    String name;
    Thread t;
    newProducerThread producer;

    newConsumerThread(String threadName, newProducerThread producer) {
        this.name = threadName;
...
public class q1 {
    public static void main(String[] args) {
        newProducerThread producer = new newProducerThread("Producer");
        newConsumerThread consumer = new newConsumerThread("Consumer", producer);
    }
}
